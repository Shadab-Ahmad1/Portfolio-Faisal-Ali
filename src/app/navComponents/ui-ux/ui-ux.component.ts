...
export class UIUXComponent implements OnInit {
  ...
  public categories = [
    ...
    },
    {
      name: 'Wireframes',
      images: [
        { id: 1,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/Artisan-Thumbnail.jpg', path: 'portfolio/wireframes/Artisan-min.jpg' },
        { id: 2,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/BrainHub-Thumbnail.jpg', path: 'portfolio/wireframes/BrainHub-min.jpg' },
        { id: 3,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/Codec-Thumbnail.jpg', path: 'portfolio/wireframes/codeq-min.jpg' },
        { id: 4,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/codigodelsur-thumbnail.jpg', path: 'portfolio/wireframes/Codigodelsur-min.jpg' },
        { id: 5,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/createIT-Thumbnail.jpg', path: 'portfolio/wireframes/createIT-min.jpg' },
        { id: 6,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/DataArt-thumbnail.jpg', path: 'portfolio/wireframes/data-art-min.jpg' },
        { id: 7,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/defaultvalue-Thumbnail.jpg', path: 'portfolio/wireframes/Default-value-min.jpg' },
        { id: 8,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/divante-Thumbnail.jpg', path: 'portfolio/wireframes/divante-min.jpg' },
        { id: 9,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/GojiLabs-thumbnail.jpg', path: 'portfolio/wireframes/GojiLabs-min.jpg' },
        { id: 10,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/grupa-Thumbnail.jpg', path: 'portfolio/wireframes/GRUPA-KMK-min.jpg' },
        { id: 11,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/lingaro-Thumbnail.jpg', path: 'portfolio/wireframes/LINGARO-min.jpg' },
        { id: 12,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/Memory-Squared.jpg', path: 'portfolio/wireframes/memory-min.jpg' },
        { id: 13,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/momentum-thumbnail.jpg', path: 'portfolio/wireframes/Momentum-IO-min.jpg' },
        { id: 14,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/soda-digital-thumbnail.jpg', path: 'portfolio/wireframes/netalico-commerce-min.jpg' },
        { id: 15,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/Pinnacle-thumbnail.jpg', path: 'portfolio/wireframes/Pinnacle-min.jpg' },
        { id: 16,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/Pixelplex-thumbnail.jpg', path: 'portfolio/wireframes/pixelplex-min.jpg' },
        { id: 17,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/stotek-thumbnail.jpg', path: 'portfolio/wireframes/softatek-min.jpg' },
        { id: 18,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/SPACEDEV-thumbnail.jpg', path: 'portfolio/wireframes/SpaceDev-min.jpg' },
        { id: 19,projectName:'Soda-Digital',thumbnailImage:'portfolio/mockups/sungroup-Thumbnail.jpg', path: 'portfolio/wireframes/Sun-o-group-min.jpg' },
